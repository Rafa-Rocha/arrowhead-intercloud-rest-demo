...
import eu.arrowhead.client.common.model.ArrowheadCloud;
...
public class ConsumerMain {
  ...
  private ServiceRequestForm compileSRF() {
     ...
     */
    ArrowheadSystem consumer = new ArrowheadSystem(consumerSystemName, "192.168.60.22", 8080, "null");
    ...
    ArrowheadSystem providerSystem = new ArrowheadSystem("InsecureTemperatureSensor", "192.168.60.62", 8460, "null");
    ArrowheadCloud providerCloud = new ArrowheadCloud("cloud-2-operator", "Cloud-2", "192.168.60.62", 8446, "gatekeeper", null, false);
    PreferredProvider provider = new PreferredProvider(providerSystem, providerCloud);
    preferredProviders.add(provider);
    */

    //Build the complete service request form from the pieces, and return it
    ServiceRequestForm srf = new ServiceRequestForm.Builder(consumer)
